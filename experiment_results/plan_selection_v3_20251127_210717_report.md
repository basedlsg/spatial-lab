...
|----------------|---------------|-------------|-----------------|
| safety_critical | 100.0% | 0.000 | 0.95 |
| time_critical | 100.0% | 0.000 | 0.90 |
| balanced | 100.0% | 0.006 | 0.90 |

**Overall Contextual Alignment:** 100.0%
**Semantic Sensitivity (mean JS divergence):** 0.1439
...
- **Complexity levels:** ['simple']
- **Repetitions per level:** 2
- **Total scenarios:** 2
- **Total trials:** 6 (scenarios × 3 contexts)
...
|-------------|---------------|
| safety_critical_vs_time_critical | 0.2158 |
| safety_critical_vs_balanced | 0.2158 |
| time_critical_vs_balanced | 0.0000 |

**Mean Sensitivity:** 0.1439
...
- Scenarios with all 3 contexts completed: 2
- Same choice across all contexts: 0 (0.0%)
