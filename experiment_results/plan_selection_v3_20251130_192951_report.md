...
| time_critical | 100.0% | 0.000 | 0.92 |
| balanced | 100.0% | 0.049 | 0.82 |

**Overall Contextual Alignment:** 100.0%
**Semantic Sensitivity (mean JS divergence):** 0.2386
...
- **Total scenarios:** 6
- **Total trials:** 18 (scenarios × 3 contexts)
...
|-------------|---------------|
| safety_critical_vs_time_critical | 0.0749 |
| safety_critical_vs_balanced | 0.4228 |
| time_critical_vs_balanced | 0.2180 |

**Mean Sensitivity:** 0.2386
...
- Scenarios with all 3 contexts completed: 5
